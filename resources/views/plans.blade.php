        ...
        <div class="row justify-content-center">
            ...
            <div class="col-4 p-3">
                <div class="border border-5 rounded-3 border-success p-5 text-center bg-black">
                    ...
                    <a href="{{ route('plano.selected',['id'=>$prices['yearly']]) }}" class="btn btn-success mt-3 w-100">ASSINAR</a>
            ...
            <div class="col-4 p-3">
                <div class="border border-2 rounded-3 border-warning p-5 text-center">
                    <h3>Plano de 3 anos</h1>
                    <hr>
                    <h1 class="text-center text-white">199.99$</h4>
                    <a href="{{ route('plano.selected',['id'=>$prices['longest']]) }}" class="btn btn-warning mt-3 w-100">ASSINAR</a>
                </div>
            </div>
